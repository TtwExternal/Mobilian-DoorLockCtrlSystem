...
}});global.win.loadURL(global.REQUIRES.url.format({pathname:global.process.cwd()+"/index.html",protocol:"file:",slashes:true}));global.win.webContents.openDevTools();global.win.webContents.initialize();global.win.on("closed",function(e){global.win=null;});};
