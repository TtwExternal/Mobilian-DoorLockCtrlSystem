//----------------------------------------------------------------------------------------------------;
var fileNm = "js__GIS/ui_gis/map_google/window.ui_gis.map_google.basic.js";
 ...
 */
window.ui_gis.map_google.basic = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_gis.map_google.basic():{Array}----------" );

	var host = window.b2link.url.getServerURLByServers( "SYS0015_WebServer" );

	var p = {
		url : host + "/ui/gis/map/google/"
		, nm : "basic"
		, css_url : host + "/css_ui/"
		, css_front_nm : "div-gis-map-google-basic"
		, key : "gis-map$google-basic"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_gis.map_google.basic():{Array}----------" );
	return o;
};
