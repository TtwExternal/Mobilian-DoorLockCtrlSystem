//----------------------------------------------------------------------------------------------------;
var fileNm = "js__GIS/ui_gis/map_openlayers/window.ui_gis.map_openlayers.basic.js";
 ...
 */
window.ui_gis.map_openlayers.basic = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_gis.map_openlayers.basic():{Array}----------" );

	var host = window.b2link.url.getServerURLByServers( "SYS0015_WebServer" );

	var p = {
		url : host + "/ui/gis/map/openlayers/"
		, nm : "basic"
		, css_url : host + "/css_ui/"
		, css_front_nm : "div-gis-map-openlayers-basic"
		, key : "gis-map$openlayers-basic"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_gis.map_openlayers.basic():{Array}----------" );
	return o;
};
