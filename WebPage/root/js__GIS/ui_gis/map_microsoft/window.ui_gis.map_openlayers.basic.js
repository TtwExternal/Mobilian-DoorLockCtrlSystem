//----------------------------------------------------------------------------------------------------;
var fileNm = "js__GIS/ui_gis/map_microsoft/window.ui_gis.map_microsoft.basic.js";
 ...
 */
window.ui_gis.map_microsoft.basic = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_gis.map_microsoft.basic():{Array}----------" );

	var host = window.b2link.url.getServerURLByServers( "SYS0015_WebServer" );

	var p = {
		url : host + "/ui/gis/map/microsoft/"
		, nm : "basic"
		, css_url : host + "/css_ui/"
		, css_front_nm : "div-gis-map-microsoft-basic"
		, key : "gis-map$microsoft-basic"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_gis.map_microsoft.basic():{Array}----------" );
	return o;
};
