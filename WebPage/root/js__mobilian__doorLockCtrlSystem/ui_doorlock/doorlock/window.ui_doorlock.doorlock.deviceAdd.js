//----------------------------------------------------------------------------------------------------;
var fileNm = "js__mobilian__doorLockCtrlSystem/ui_doorlock/doorlock/window.ui_doorlock.doorlock.deviceAdd.js";
 ...
 */
window.ui_doorlock.doorlock.deviceAdd = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_doorlock.doorlock.deviceAdd():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_doorlock.doorlock.deviceAdd():{Array}----------" );
	return o;
};
