//----------------------------------------------------------------------------------------------------;
var fileNm = "js__mobilian__doorLockCtrlSystem/ui_doorlock/doorlock/window.ui_doorlock.doorlock.deviceControl.js";
 ...
 */
window.ui_doorlock.doorlock.deviceControl = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_doorlock.doorlock.deviceControl():{Array}----------" );
	...
	var p = {
		...
		, key : "doorlock-doorlock$deviceControl"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_doorlock.doorlock.deviceControl():{Array}----------" );
	return o;
};
