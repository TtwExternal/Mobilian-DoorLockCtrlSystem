//----------------------------------------------------------------------------------------------------;
var fileNm = "js__mobilian__doorLockCtrlSystem/ui_doorlock/doorlock/window.ui_doorlock.doorlock.deviceInstall.js";
 ...
 */
window.ui_doorlock.doorlock.deviceInstall = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_doorlock.doorlock.deviceInstall():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_doorlock.doorlock.deviceInstall():{Array}----------" );
	return o;
};
