 //----------------------------------------------------------------------------------------------------;
//var fileNm = "js--Semantic-UI/smt_ui/message/window.smt_ui.message.error.js";
 ...
 */
window.smt_ui.message.error = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.smt_ui.message.error():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.smt_ui.message.error():{Array}----------return o;" );
	return o;
};
