 //----------------------------------------------------------------------------------------------------;
//var fileNm = "js--Semantic-UI/smt_ui/message/window.smt_ui.message.success.js";
 ...
 */
window.smt_ui.message.success = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.smt_ui.message.success():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.smt_ui.message.success():{Array}----------return o;" );
	return o;
};
