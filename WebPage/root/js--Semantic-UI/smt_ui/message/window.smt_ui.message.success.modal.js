 //----------------------------------------------------------------------------------------------------;
//var fileNm = "js--Semantic-UI/smt_ui/message/window.smt_ui.message.success.modal.js";
 ...
 */
window.smt_ui.message.success.modal = function()
{
	window.TtwLog.timeStamp( "---- [ S ] - window.smt_ui.message.success.modal():{Array}----------" );

	var host = window.b2link.url.getServerURLByServers( "SYS0015_WebServer" );

	var p = {
		url : host + "/ui/smt_ui/Message/Variations/Success/"
		//url : host + "/ui--Semantic-UI/smt_ui/Message/Variations/Success/"
		, nm : "smt_ui-Message-Variations-Success"
		, css_url : host + "/css_ui/"
		, css_front_nm : "div-"
		, key : "smt_ui$Message.Variations.Success"
	};
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.smt_ui.message.success.modal():{Array}----------return o;" );
	return o;
};
