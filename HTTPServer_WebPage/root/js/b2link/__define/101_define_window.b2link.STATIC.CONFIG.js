...
window.b2link.STATIC.CONFIG.URL.SERVER = "http://localhost:30000/";
//window.b2link.STATIC.CONFIG.URL.SCODE = "session-server::webserver";//시스템 개별 정의;
window.b2link.STATIC.CONFIG.URL.SCODE = "SYS0010::webserver";//시스템 개별 정의;
