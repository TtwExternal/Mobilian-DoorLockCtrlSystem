//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__mobilian__memberCtrlSystem/mobilian_router/member/member_basic/approval.js";
 ...
 * @property {String}
 */
//var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.member.PATH.member_basic + "approval.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:49320/member/member_basic/approval?
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - member/member_basic/approval():void----------" );

	var q = global.b2link.url.getQueryFromURL( req.url );//URL to Query Object;

	//MongoDB Template Query를 dbjs 파일로부터 가져오기 - 가입 요청한 사용자 승인;
	var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.member.PATH.member_basic + "approval.dbjs" );
	var query = _query.replace( "<!=data=!>", q.data );

	//Template Query의 변경 값을 반영 한후 로컬에 query로 저장하기;
	global.b2link.fs.writeQuery( global.mobilian_router.member.PATH.member_basic + "approval.query", query );
	...
	global.TtwLog.log( "- [ E ] - member/member/approval():void----------" );
});