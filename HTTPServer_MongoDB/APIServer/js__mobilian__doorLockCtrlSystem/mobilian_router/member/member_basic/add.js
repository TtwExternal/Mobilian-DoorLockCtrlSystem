//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__mobilian__memberCtrlSystem/mobilian_router/member/member_basic/add.js";
 ...
 * @property {String}
 */
//var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.member.PATH.member_basic + "add.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:49320/member/member_basic/add?
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - member/member_basic/add():void----------" );

	var q = global.b2link.url.getQueryFromURL( req.url );//URL to Query Object;

	//MongoDB Template Query를 dbjs 파일로부터 가져오기 - 사용자 등록;
	var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.member.PATH.member_basic + "add.dbjs" );
	var query = _query.replace( "<!=data=!>", q.data );

	//Template Query의 변경 값을 반영 한후 로컬에 query로 저장하기;
	global.b2link.fs.writeQuery( global.mobilian_router.member.PATH.member_basic + "add.query", query );
	...
	global.TtwLog.log( "- [ E ] - member/member_basic/add():void----------" );
});