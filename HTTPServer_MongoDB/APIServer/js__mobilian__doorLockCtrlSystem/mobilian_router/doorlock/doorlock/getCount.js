//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__mobilian__doorlockCtrlSystem/mobilian_router/doorlock/doorlock/getCount.js";
 ...
 * @property {String}
 */
//var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.doorlock.PATH.doorlock + "getCount.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:49320/doorlock/doorlock/getCount?
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - doorlock/doorlock/getCount():void----------" );

	var q = global.b2link.url.getQueryFromURL( req.url );//URL to Query Object;

	//MongoDB Template Query를 dbjs 파일로부터 가져오기 - 장치 목록의 갯수 가져오기;
	var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.doorlock.PATH.doorlock + "getCount.dbjs" );
	var query = _query.replace( "<!=data=!>", q.data );

	//Template Query의 변경 값을 반영 한후 로컬에 query로 저장하기;
	global.b2link.fs.writeQuery( global.mobilian_router.doorlock.PATH.doorlock + "getCount.query", query );
	...
	global.TtwLog.log( "- [ E ] - doorlock/doorlock/getCount():void----------" );
});