//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__mobilian__doorlockCtrlSystem/mobilian_router/doorlock/doorlock/getSearchList.js";
 ...
 * @property {String}
 */
//var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.doorlock.PATH.doorlock + "getSearchList.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:49320/doorlock/doorlock/getSearchList?
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - doorlock/doorlock/getSearchList():void----------" );
	...
	global.b2link.fs.writeQuery( global.mobilian_router.doorlock.PATH.doorlock + "getSearchList.query", query );
	...
	global.TtwLog.log( "- [ E ] - doorlock/doorlock/getSearchList():void----------" );
});