//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__mobilian__doorLockCtrlSystem/mobilian_router/doorlock/doorlock/deviceInstall.js";
 ...
 * @property {String}
 */
//var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.doorlock.PATH.doorlock + "deviceInstall.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:49320/doorlock/doorlock/deviceInstall?
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - doorlock/doorlock/deviceInstall():void----------" );

	var q = global.b2link.url.getQueryFromURL( req.url );//URL to Query Object;

	//MongoDB Template Query를 dbjs 파일로부터 가져오기 - 도어락 장치 설치;
	var _query = global.b2link.fs.getDBJS__require( global.mobilian_router.doorlock.PATH.doorlock + "deviceInstall.dbjs" );
	var query = _query.replace( "<!=data=!>", q.data ).replace( "<!=mid=!>", q.mid );

	//Template Query의 변경 값을 반영 한후 로컬에 query로 저장하기;
	global.b2link.fs.writeQuery( global.mobilian_router.doorlock.PATH.doorlock + "deviceInstall.query", query );
	...
	global.TtwLog.log( "- [ E ] - doorlock/doorlock/deviceInstall():void----------" );
});