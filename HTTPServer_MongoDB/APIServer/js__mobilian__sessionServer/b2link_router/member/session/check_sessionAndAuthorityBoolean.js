//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__b2link__sessionServer/b2link_router/member/session/check_sessionAndAuthorityBoolean.js";
 ...
 * @property {String}
 */
//var _query = global.b2link.fs.getDBJS( global.b2link_router.member.PATH.session + "check_sessionAndAuthorityBoolean.dbjs" );
var _query = global.b2link.fs.getDBJS__require( global.b2link_router.member.PATH.session + "check_sessionAndAuthorityBoolean.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:33333/member/session/check_sessionAndAuthorityBoolean
	http://localhost:33333/member/session/check_sessionAndAuthorityBoolean?sid=aslkahjslkdj
 * </code>
 */
(function( req, res ){
	global.HykLog.timeStamp( "- [ S ] - member/session/check_sessionAndAuthorityBoolean():void----------" );
	...
	global.b2link.fs.writeQuery( global.b2link_router.member.PATH.session + "check_sessionAndAuthorityBoolean.query", q.q );
	//*/
	...
	t.req_DB( req, res, q, function( error, result ){
		global.HykLog.timeStamp( "-- [ S ] - member/session/check_sessionAndAuthorityBoolean::res():void----------" );

		if( error )
		{
			//MongoDB Query 결과가 Error 일시 처리 및 Client에 전송;
			global.b2link.response.send_200_False__ErrorLog( req, res, q, error );
			global.HykLog.timeStamp( "-- [ E ] - member/session/check_sessionAndAuthorityBoolean::res():void----------if( error ) return;" );
			return;
		}
		...
		global.HykLog.timeStamp( "-- [ E ] - member/session/check_sessionAndAuthorityBoolean::res():void----------" );
	});

	global.HykLog.timeStamp( "- [ E ] - member/session/check_sessionAndAuthorityBoolean():void----------" );
});