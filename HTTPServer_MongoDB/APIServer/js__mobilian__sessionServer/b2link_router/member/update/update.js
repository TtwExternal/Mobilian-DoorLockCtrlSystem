//----------------------------------------------------------------------------------------------------;
var fileNm = "/js__b2link__sessionServer/b2link_router/member/update/update.js";
 ...
 * @property {String}
 */
//var _query = global.b2link.fs.getDBJS__require( "./js__b2link__sessionServer/b2link_router/member/update/update.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:49320/member/update/update?data="
 * </code>
 */
(function( req, res ){
	global.AlexLog.log( "- [ S ] - member/update/update():void----------" );
	...
	global.b2link.fs.writeQuery( "./js__b2link__sessionServer/b2link_router/member/update/update.query", query );
	...
	global.AlexLog.log( "- [ E ] - member/update/update():void----------" );
});